...
from losses.loss_functions import compute_pairwise_loss
...
class SC_Depth(LightningModule):
    def __init__(self, hparams):
        ...
        # self.depth_net= UNet3P()
        self.pose_net = PoseNet()

    def prepare_data(self):
        if self.hparams.hparams.dataset_name == 'kitti':
            training_size =  [256, 832] # [384, 1248] [256, 832] [160, 512] [128, 416]
    ...
    def validation_step(self, batch, batch_idx):
        ...
        #             tgt_img, ref_img, tgt_depth,ref_depth, pose, intrinsics, self.hparams)
        #         vis_diff_img = visualize_image(diff_img_tmp1[0]).unsqueeze(0)
        #         self.logger.experiment.add_images(
        #             'val/diff_img_{}'.format(batch_idx), vis_diff_img, self.current_epoch)
        # return errs
